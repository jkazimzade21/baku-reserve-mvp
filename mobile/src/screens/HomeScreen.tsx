...
export default function HomeScreen({ navigation }: Props) {
  ...
  const handleFooterPress = () => {
    Haptics.selectionAsync().catch(() => {});
    navigation.navigate('Explore', { resetToTop: true });
  };
            ...
            >
              ...
              <View style={styles.compactBody}>
                ...
                <Text style={styles.compactMeta} numberOfLines={1}>
                  {restaurant.neighborhood || (restaurant.cuisine ?? [])[0] || 'Baku'}
                </Text>
              </View>
            </Pressable>
          );
  ...
  return (
    <SafeAreaView style={styles.safe} edges={['top', 'left', 'right']}>
      ...
      >
        ...
        <Pressable style={styles.conciergeLink} onPress={handleFooterPress} accessibilityRole="button">
          <Text style={styles.conciergeText}>Need ideas? Try Concierge in Explore →</Text>
        </Pressable>
      </ScrollView>
